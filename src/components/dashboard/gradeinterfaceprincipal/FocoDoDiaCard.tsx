...
import { Target, Clock, BookOpen, Play, Check, ChevronRight, Flame, Trophy, PlusCircle } from "lucide-react";
            ...
            <div>
              ...
              {temFoco ? (
                <p className={`text-sm ${isLightMode ? 'text-gray-500' : 'text-gray-300'}`}>
                  <span className="font-bold text-[#FF6B00]">Definido por você</span>
                </p>
              ) : null}
            </div>
          </div>
