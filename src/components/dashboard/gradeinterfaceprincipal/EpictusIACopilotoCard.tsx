...
export default function EpictusIACopilotoCard() {
  ...
  return (
    <motion.div
      ...
      className="rounded-xl overflow-hidden border border-gray-100 dark:border-gray-800 shadow-xl bg-white dark:bg-gradient-to-br dark:from-[#0c1425] dark:to-[#0a1a2e] h-auto max-h-[550px] w-full relative flex flex-col"
    >
