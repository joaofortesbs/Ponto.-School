        ...
        {cardData.map((card) => {
          ...
          return (
            ...
            >
              ...
              <div className={`absolute inset-0 bg-gradient-to-br ${card.accentColor} opacity-0 group-hover:opacity-100 transition-opacity duration-500`} />
                ...
                {!card.isWide ? (
                  <>
                    ...
                    <div className="flex-1 min-w-0">
                      <p className={`text-xs font-semibold mb-1 tracking-wide uppercase ${isLightMode ? 'text-gray-500 group-hover:text-orange-600' : 'text-gray-400 group-hover:text-orange-400'} transition-colors duration-300`}>
                        {card.title}
                      </p>
                      <h3 className={`text-2xl font-bold tracking-tight ${isLightMode ? 'text-gray-900 group-hover:text-orange-600' : 'text-white group-hover:text-orange-400'} transition-all duration-300 group-hover:scale-105 origin-left`}>
                        {card.value}
                      </h3>
                    </div>
                  </>
                  ...
                  <>
                    ...
                    {/* Enhanced IA Content */}
                    <div className="flex-1 min-w-0">
                      <p className={`text-xs font-bold mb-1.5 tracking-wide ${isLightMode ? 'text-orange-600' : 'text-orange-400'} flex items-center gap-2`}>
                        {card.title}
                      ...
                      <p className={`text-xs leading-relaxed line-clamp-2 ${isLightMode ? 'text-gray-600 group-hover:text-gray-800' : 'text-gray-400 group-hover:text-gray-200'} transition-colors duration-300`}>
                        {card.description}
                      </p>
                    </div>
                  </>
