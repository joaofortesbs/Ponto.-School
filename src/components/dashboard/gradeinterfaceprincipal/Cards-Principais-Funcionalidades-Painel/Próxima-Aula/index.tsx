  ...
  return (
    <Card
      className={`
        ...
        ${isLightMode 
          ? 'bg-white/95 border-2 border-blue-100/60 hover:border-blue-300/80' 
          : 'bg-[#001F3F]/60 border-2 border-blue-500/15 hover:border-blue-500/35'
        }
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-blue-600/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700 ease-out" />
      ...
      <CardContent className="relative p-6 h-full flex flex-col z-10">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            <i className="fas fa-calendar text-blue-500 text-lg"></i>
        ...
        {/* Timestamp */}
        <div className={`mb-4 pb-4 border-b ${isLightMode ? 'border-gray-200' : 'border-gray-700'}`}>
          <div className="flex items-center gap-2">
        ...
        {/* Info Principal */}
        <div className={`mb-4 p-4 rounded-xl ${isLightMode ? 'bg-orange-50' : 'bg-orange-500/10'}`}>
        ...
        {/* Status Checklist */}
        <div className={`mb-4 p-4 rounded-xl border-2 border-dashed ${isLightMode ? 'border-green-300 bg-green-50/50' : 'border-green-500/30 bg-green-500/5'}`}>
        ...
        {/* Insight IA */}
        <div className={`mb-4 p-3 rounded-lg ${isLightMode ? 'bg-yellow-50 border-l-4 border-yellow-500' : 'bg-yellow-500/10 border-l-4 border-yellow-400'}`}>
          <div className="flex items-start gap-2">
            ...
            <p className={`text-xs ${isLightMode ? 'text-yellow-800' : 'text-yellow-200'}`}>
              15 alunos erraram este tema na última trilha - Reforço recomendado
            </p>
          </div>
        </div>
        ...
        <div className={`text-xs ${isLightMode ? 'text-gray-500' : 'text-gray-400'} truncate`}>
          <span>&gt; Próximas: História (10:00) • Ciências...</span>
        </div>
      </CardContent>
    </Card>
  );
