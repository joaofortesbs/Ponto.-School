...
export default function DashboardMetricsGrid() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
      ...
      <div className="group bg-gradient-to-br from-[#0A2540] to-[#0D2B4A] rounded-xl p-4 border border-[#2A4D6E]/30 shadow-lg relative overflow-hidden transition-all duration-300 hover:shadow-xl hover:border-[#FF6B00]/30 hover:translate-y-[-4px]">
      ...
      <div className="group bg-gradient-to-br from-[#0A2540] to-[#0D2B4A] rounded-xl p-4 border border-[#2A4D6E]/30 shadow-lg relative overflow-hidden transition-all duration-300 hover:shadow-xl hover:border-[#FF6B00]/30 hover:translate-y-[-4px]">
        ...
        <p className="text-xs text-gray-500 mt-1">Top 25%</p>
      </div>
      ...
      <div className="group bg-gradient-to-br from-[#0A2540] to-[#0D2B4A] rounded-xl p-4 border border-[#2A4D6E]/30 shadow-lg relative overflow-hidden transition-all duration-300 hover:shadow-xl hover:border-[#FF6B00]/30 hover:translate-y-[-4px]">
        ...
        <div className="flex items-end">
          <h3 className="text-3xl font-bold text-white">1250</h3>
          <span className="text-sm text-gray-400 ml-1 mb-0.5">sp</span>
        </div>

        <p className="text-xs text-gray-500 mt-1">Próximo nível: 1500</p>
      </div>
    </div>
  );
}
