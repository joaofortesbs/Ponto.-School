...
export default function DashboardMetricsGrid() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
      ...
      <div className="group bg-gradient-to-br from-[#0A2540] to-[#0D2B4A] rounded-xl p-4 border border-[#2A4D6E]/30 shadow-lg relative overflow-y-auto custom-scrollbar transition-all duration-300 hover:shadow-xl hover:border-[#FF6B00]/30 hover:translate-y-[-4px]" style={{ height: "130px" }}>
