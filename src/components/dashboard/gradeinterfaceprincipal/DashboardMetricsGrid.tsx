    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
      ...
      <div className="group bg-gradient-to-br from-[#0A2540] to-[#0D2B4A] rounded-xl p-5 border border-[#2A4D6E]/30 shadow-lg relative overflow-hidden transition-all duration-300 hover:shadow-xl hover:border-[#FF6B00]/30 hover:translate-y-[-4px]">
        ...
        <div className="flex justify-between items-start mb-4 relative z-10">
          ...
          <span className="text-xs font-medium bg-[#FF6B00]/20 text-[#FF6B00] py-1 px-2 rounded-full">+4 aulas</span>
        </div>

        <p className="text-sm text-gray-400 mb-4 font-medium">Aulas concluídas</p>
        <h2 className="text-3xl font-bold text-white">24 <span className="text-base font-medium text-gray-400">aulas</span></h2>
      </div>
      ...
      <div className="group bg-gradient-to-br from-[#0A2540] to-[#0D2B4A] rounded-xl p-5 border border-[#2A4D6E]/30 shadow-lg relative overflow-hidden transition-all duration-300 hover:shadow-xl hover:border-[#FF6B00]/30 hover:translate-y-[-4px]">
        ...
        <div className="flex justify-between items-start mb-4 relative z-10">
          ...
          <span className="text-xs font-medium bg-green-500/20 text-green-400 py-1 px-2 rounded-full">↑ 3 posições</span>
        </div>

        <p className="text-sm text-gray-400 mb-4 font-medium">Posição ranking</p>
        <h2 className="text-3xl font-bold text-white">#42 <span className="text-base font-medium text-gray-400">/ ranking</span></h2>
      ...
      <div className="group bg-gradient-to-br from-[#0A2540] to-[#0D2B4A] rounded-xl p-5 border border-[#2A4D6E]/30 shadow-lg relative overflow-hidden transition-all duration-300 hover:shadow-xl hover:border-[#FF6B00]/30 hover:translate-y-[-4px]">
        ...
        <div className="flex justify-between items-start mb-4 relative z-10">
          ...
          <span className="text-xs font-medium bg-[#FF6B00]/20 text-[#FF6B00] py-1 px-2 rounded-full">+250 pontos</span>
        </div>

        <p className="text-sm text-gray-400 mb-4 font-medium">School Points</p>
        <h2 className="text-3xl font-bold text-white">1250 <span className="text-base font-medium text-gray-400">sp</span></h2>

        <div className="mt-1">
          <p className="text-xs text-gray-500">Próximo nível: 1500</p>
        </div>
      </div>
    </div>
  );
