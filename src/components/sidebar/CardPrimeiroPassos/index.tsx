                        ...
                        >
                          <div className="px-3 pb-3 pt-1 space-y-2 border-t border-orange-200 dark:border-orange-800/30">
                            {item.content.map((step, index) => (
                              <div
                                key={index}
                                className="text-gray-600 dark:text-gray-400 text-xs py-1"
                              >
                                ...
                                {/* Botão Criar Atividade apenas no step "Configure e gere sua atividade" dentro do item "Criar uma atividade" */}
                                {item.id === '2' && step === 'Configure e gere sua atividade' && (
