  ...
  return (
    <div className="relative h-full">
      ...
      >
        ...
        <div
          className={cn(
            "relative transform-gpu preserve-3d transition-transform duration-500",
        ...
        >
          ...
          <div
            className={cn(
              "bg-white dark:bg-[#29335C]/20 rounded-xl border border-gray-200 dark:border-[#29335C]/30 backdrop-blur-sm absolute inset-0",
          ...
          <div
            className={cn(
              "absolute top-0 left-0 bg-gradient-to-br from-[#FF6B00] to-[#FF8736] rounded-xl border border-orange-300 backdrop-blur-sm backface-hidden",
              isCollapsed ? "w-14 p-2 h-16" : "w-full p-4",
            )}
            style={{
