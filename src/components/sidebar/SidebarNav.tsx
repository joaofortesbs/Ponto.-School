  ...
  return (
    <div className="relative h-full">
      ...
      >
        ...
        >
          <motion.div
            className="absolute top-3 right-3 w-6 h-6 rounded-md bg-gray-100 dark:bg-[#29335C]/40 hover:bg-gray-200 dark:hover:bg-[#29335C]/60 flex items-center justify-center transition-all duration-200 hover:scale-105 cursor-pointer"
            onClick={() => setIsFlipped(!isFlipped)}
          >
            <svg
                ...
                isCollapsed ? (
                  <Button
                    ...
                    className={cn(
                      ...
                      isActive(item.path)                      ? "bg-[#FF6B00]/10 text-[#FF6B00] dark:bg-[#FF6B00]/20 dark:text-[#FF6B00]"
