                ...
                <DropdownMenuContent align="end" className="w-56 p-0 overflow-hidden border-0"
                    style={{
                      background: isLightMode 
                        ? 'linear-gradient(135deg, rgba(255, 255, 255, 0.98) 0%, rgba(248, 250, 252, 0.95) 50%, rgba(240, 245, 250, 0.92) 100%)'
                      ...
                      boxShadow: isLightMode
                        ? '0 25px 50px -12px rgba(0, 0, 0, 0.08), 0 8px 16px -8px rgba(255, 107, 0, 0.06), inset 0 1px 0 rgba(255, 255, 255, 0.8)'
                  ...
                  >
                    ...
                    <div 
                      ...
                      style={{
                        background: isLightMode 
                          ? 'linear-gradient(135deg, rgba(255, 107, 0, 0.05) 0%, rgba(255, 140, 64, 0.02) 100%)'
                    ...
                    >
                      <div className={`absolute inset-0 ${isLightMode ? 'bg-gradient-to-r from-transparent via-[#FF6B00]/2 to-transparent' : 'bg-gradient-to-r from-transparent via-[#FF6B00]/3 to-transparent'}`} />
                      <h3 className={`text-sm font-light relative z-10 tracking-wide ${isLightMode ? 'text-gray-800' : 'text-white/90'}`}>
                        Minha Conta
                      </h3>
                    </div>
                    ...
                    <div className="py-3 px-2">
                      <DropdownMenuItem 
                        className={`mx-2 my-1.5 rounded-lg cursor-pointer transition-all duration-300 group relative overflow-hidden border border-transparent ${
                          isLightMode 
                            ? 'hover:bg-gray-50 text-gray-700 hover:text-gray-900 focus:bg-gray-50 focus:text-gray-900 hover:border-gray-200'
                      ...
                      >
                        <div className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 ${
                          isLightMode 
                            ? 'bg-gradient-to-r from-transparent via-[#FF6B00]/3 to-transparent'
                            : 'bg-gradient-to-r from-transparent via-[#FF6B00]/5 to-transparent'
                        }`} />
                    ...
                    <div 
                      ...
                      style={{
                        background: isLightMode 
                          ? 'linear-gradient(to right, transparent, rgba(255, 107, 0, 0.1), transparent)'
                    ...
                    <div className="pb-3 px-2">
                      <DropdownMenuItem 
                        className={`mx-2 my-1.5 rounded-lg cursor-pointer transition-all duration-300 group relative overflow-hidden border border-transparent ${
                          isLightMode 
                            ? 'hover:bg-red-50 text-gray-600 hover:text-red-600 focus:bg-red-50 focus:text-red-600 hover:border-red-200'
                      ...
                      >
                        <div className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 ${
                          isLightMode 
                            ...
                            : 'bg-gradient-to-r from-transparent via-red-500/8 to-transparent'
                        }`} />
                        <LogOut className={`mr-3.5 h-4 w-4 relative z-10 group-hover:text-red-600 transition-colors duration-300 ${
                          isLightMode ? 'text-gray-400 group-hover:text-red-600' : 'text-white/50 group-hover:text-red-400'
                        }`} />
