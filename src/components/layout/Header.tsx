          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-48 p-0 overflow-hidden border-0 backdrop-blur-md bg-white/90 dark:bg-[#0A2540]/90 border border-[#FF6B00]/30 shadow-lg shadow-[#FF6B00]/5"
                  >
                    {/* Header minimalista */}
                    <div className="p-3 bg-gradient-to-r from-orange-100 to-orange-200 dark:from-orange-900 dark:to-orange-800 border-b rounded-t-xl">
                      <h3 className="text-sm font-bold text-gray-800 dark:text-white tracking-wide text-center">
                        Minha Conta
                      </h3>
                    </div>
                    ...
                    <div className="p-2">
                      <DropdownMenuItem 
                        className="flex items-center space-x-2 hover:bg-orange-50 dark:hover:bg-orange-900/10 text-gray-900 dark:text-white cursor-pointer transition-all duration-200 p-2 rounded-md"
                    ...
                    {/* Separator sutil */}
                    <div className="mx-4 my-2 h-px bg-gradient-to-r from-transparent via-[#FF6B00]/30 to-transparent" />

                    {/* Logout com destaque sutil */}
                    <div className="p-2 border-t border-orange-100 dark:border-orange-800">
                      <DropdownMenuItem 
                        className="flex items-center space-x-2 hover:bg-red-50 dark:hover:bg-red-900/10 text-gray-900 dark:text-white hover:text-red-500 dark:hover:text-red-400 cursor-pointer transition-all duration-200 p-2 rounded-md"
