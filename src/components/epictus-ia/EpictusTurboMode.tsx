...
// Componente ErrorBoundary específico para o módulo Epictus
class EpictusErrorBoundary extends React.Component<
...
> {
  ...
  componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    console.error("Erro no módulo Epictus IA:", error);
    ...
    if (this.state.hasError) {
      return this.props.fallback || (
        <div className="p-6 bg-red-50 dark:bg-red-900/20 rounded-lg my-4">
          <h3 className="text-red-700 dark:text-red-300 font-medium mb-2">Erro no carregamento do Epictus IA</h3>
...
const EpictusTurboMode: React.FC = () => {
  console.log("Renderizando EpictusTurboMode");
  ...
  useEffect(() => {
    try {
      ...
      console.error("Erro ao configurar o listener de seleção de perfil:", error);
    }
  }, []);
