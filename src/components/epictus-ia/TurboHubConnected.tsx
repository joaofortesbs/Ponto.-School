...
const TurboHubConnected: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-4 mt-2 mb-6">
      <div 
        ref={containerRef}
        className="relative min-h-[400px] bg-gradient-to-r from-[#050e1d] to-[#0d1a30] rounded-2xl shadow-xl border border-white/5 overflow-hidden"
      >
        {/* Partículas de fundo */}
        ...
        <AnimatePresence>
          {focusedNodeData && (
            <motion.div 
              className="absolute right-8 top-1/2 -translate-y-1/2 z-40 bg-gradient-to-r from-[#0c2341]/80 to-[#0f3562]/80 backdrop-blur-md border border-white/10 rounded-xl shadow-2xl max-w-xs"
