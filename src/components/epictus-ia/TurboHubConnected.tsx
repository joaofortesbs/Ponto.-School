    ...
    <div className="w-full max-w-5xl mx-auto px-4 mt-2 mb-6">
      ...
      >
        ...
        <AnimatePresence>
          {focusedNodeData && (
            <motion.div 
              className="absolute right-8 top-1/3 -translate-y-1/2 z-40 bg-gradient-to-r from-[#0c2341]/80 to-[#0f3562]/80 backdrop-blur-md border border-white/10 rounded-xl shadow-2xl max-w-xs"
