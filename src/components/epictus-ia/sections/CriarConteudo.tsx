...
You will also need to create the file `src/components/epictus-ia/sections/CriarConteudo/components/criar-conteudo.tsx`  with the following content:

```typescript
// src/components/epictus-ia/sections/CriarConteudo/components/criar-conteudo.tsx
import React from "react";
