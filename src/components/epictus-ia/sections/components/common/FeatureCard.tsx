...
const FeatureCard: React.FC<FeatureCardProps> = ({ feature }) => {
  ...
  return (
    <Card 
      className={`p-5 h-full border overflow-hidden group relative ${theme === "dark" ? "bg-gray-800/70 border-gray-700" : "bg-white border-gray-200"} hover:shadow-lg transition-all duration-300 hover:translate-y-[-2px] ${feature.highlight ? "glow-effect" : ""}`}
      onMouseMove={(e) => {
