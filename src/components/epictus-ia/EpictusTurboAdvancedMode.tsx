    ...
    <div className="w-full flex flex-col items-center">
      ...
      <div className="w-full flex flex-col items-center justify-center mt-0 mb-2">
        ...
        <div className="w-full bottom-0 left-0 right-0 z-30 mt-8">
          {/* Componente de Espaços de aprendizado */}
          <div className="w-full flex justify-end px-4 mb-2">
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#0c2341] cursor-pointer hover:bg-[#0f3562] transition-colors">
              ...
              <span className="px-1.5 py-0.5 text-xs font-medium rounded bg-orange-500/80 text-white ml-1">Novo</span>
            </div>
          </div>
          <TurboMessageBox />
        </div>
...
// Assuming a basic structure for TurboMessageBox.  This needs to be fleshed out based on your actual component.
const TurboMessageBox = () => {
  return (
    <div className="w-full p-4 bg-gray-800 rounded-lg shadow-md">
      <div className="flex justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
          >
            <svg xmlns="http://www.w3.org/200/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white">
      ...
      {/* Rest of the message box content */}
    </div>
  );
};
