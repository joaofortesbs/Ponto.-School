...
const SolarSystemEpictusTurbo: React.FC<SolarSystemEpictusTurboProps> = ({ 
  ...
  return (
    <div className="relative w-full max-w-screen-2xl mx-auto h-[50vh] flex items-center justify-center overflow-hidden bg-transparent"> {/* Increased width with transparent background */}
