...
const EpictusIAMode: React.FC = () => {
  ...
  const profileOptions = [
    { 
      id: "estudante",
      icon: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#FF6B00]"><path d="M12 10v-2a2 2 0 0 0-2-2V4"></path><path d="M10 4H8a2 2 0 0 0-2 2v1a2 2 0 0 0-2 2v1"></path><path d="M14 4h2a2 2 0 0 1 2 2v1a2 2 0 0 1 2 2v1"></path><path d="M18 15v1a2 2 0 0 1-2 2h-1a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2h-1a2 2 0 0 1-2-2v-1a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2Z"></path></svg>, 
      color: "#FF6B00", 
      name: "Estudante",
      onClick: () => {
    ...
    { 
      id: "professor",
      icon: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#FF8736]"><path d="M8 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3.93a2 2 0 0 1-1.66-.9L15.12 4a2 2 0 0 0-1.66-.9H8.83A3 3 0 0 0 6 5.17V17"></path><path d="M2 14h7"></path><path d="M6 10 2 14l4 4"></path></svg>, 
      color: "#FF8736", 
      name: "Professor",
      onClick: () => {
    ...
    { 
      id: "coordenador",
      icon: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#FF6B00]"><path d="M15.5 2H8.6c-.4 0-.8.2-1.1.5-.3.3-.5.7-.5 1.1v12.8c0 .4.2.8.5 1.1.3.3.7.5 1.1.5h9.8c.4 0 .8-.2 1.1-.5.3-.3.5-.7.5-1.1V6.5L15.5 2z"></path><path d="M3 7.6v12.8c0 .4.2.8.5 1.1.3.3.7.5 1.1.5h9.8"></path><path d="M15 2v5h5"></path></svg>, 
      color: "#FF6B00", 
      name: "Coordenador",
      onClick: () => {
    ...
    { 
      id: "expert",
      icon: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#FF8736]"><path d="M12 2a10 10 0 1 0 10 10 4 4 0 0 1-5-5 4 4 0 0 1-5-5"></path><path d="M8.5 8.5v.01"></path><path d="M16 15.5v.01"></path><path d="M12 12v.01"></path><path d="M11 17v.01"></path><path d="M7 14v.01"></path></svg>, 
      color: "#FF8736", 
      name: "Expert",
      onClick: () => {
    ...
    <div className="w-full flex flex-col items-center">
      ...
      <div className="w-full p-4">
        ...
        >
          ...
          {/* Glowing orbs */}
          <motion.div 
            className="absolute top-1/2 left-1/4 w-32 h-32 rounded-full bg-[#FF6B00]/10 blur-3xl"
            animate={{
              scale: [1, 1.2, 1],
              opacity: [0.2, 0.3, 0.2],
            }}
          ...
          <motion.div 
            className="absolute bottom-0 right-1/4 w-40 h-40 rounded-full bg-[#FF8736]/10 blur-3xl"
            animate={{
              scale: [1, 1.3, 1],
          ...
          <div className="flex items-center gap-4 z-10 flex-1">
            <div className="relative group mr-3">
              <div className={`absolute inset-0 bg-gradient-to-br from-[#FF6B00] via-[#FF8736] to-[#FFA776] rounded-full ${isHovered ? 'blur-[6px]' : 'blur-[3px]'} opacity-80 group-hover:opacity-100 transition-all duration-300 scale-110`}></div>
              <motion.div 
                className="w-12 h-12 rounded-full bg-gradient-to-br from-[#FF6B00] to-[#FF8736] flex items-center justify-center relative z-10 border-2 border-white/10 shadow-xl"
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-2">
                ...
                <motion.div
                  className="flex items-center px-1.5 py-0.5 rounded-md bg-gradient-to-r from-[#FF6B00] to-[#FF8736] text-xs font-medium text-white shadow-lg dropdown-isolate personalidades-root"
                  whileHover={{ scale: 1.05 }}
                  transition={{ type: "spring", stiffness: 400, damping: 10 }}
                >
              ...
              <p className="text-white/70 text-sm mt-0.5 font-medium tracking-wide">
                Inteligência artificial avançada para aprendizado personalizado
              </p>
            </div>
          </div>

          {/* Personalidades e ícones de navegação */}
          <div className="flex items-center justify-center z-10 relative gap-3">
            ...
            <div className="relative icon-container mr-5 group" style={{ zIndex: 99999, position: "relative" }}>
              <motion.div
                className="relative w-auto h-10 rounded-full bg-gradient-to-br from-[#FF6B00] to-[#FF8736] flex items-center justify-center cursor-pointer shadow-lg hover:shadow-xl transition-shadow px-3 group"
            ...
            <div className="relative icon-container">
              <motion.div
                className="w-10 h-10 rounded-full bg-gradient-to-br from-[#FF6B00] to-[#FF8736] flex items-center justify-center cursor-pointer shadow-lg hover:shadow-xl transition-shadow"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                initial={false}
                transition={{ duration: 0.3 }}
            ...
            <div className="relative profile-icon-container ml-4">
              <motion.div
                className="w-11 h-11 rounded-full bg-gradient-to-br from-[#FF6B00] to-[#FF8736] p-[2px] flex items-center justify-center cursor-pointer shadow-lg hover:shadow-xl transition-shadow overflow-hidden"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                initial={false}
                transition={{ duration: 0.3 }}
...
// Componentes adicionais para a funcionalidade completa
const IAMessageBox: React.FC = () => {
  return (
    <div className="w-full p-4">
      <div className="w-full bg-gradient-to-r from-[#0c2341] to-[#0f3562] backdrop-blur-lg p-4 rounded-xl border border-white/10 shadow-xl">
        <div className="flex items-center gap-3">
          <Input
            className="flex-1 bg-black/20 border-white/10 text-white placeholder-white/50 focus-visible:ring-[#FF8736] focus-visible:ring-offset-0"
            placeholder="Digite sua pergunta ou comando aqui..."
          />
          <motion.button
            className="bg-gradient-to-r from-[#FF6B00] to-[#FF8736] text-white px-4 py-2 rounded-lg shadow-lg"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
            Enviar
...
const IAHubConnected: React.FC = () => {
  return (
    <div className="w-full p-4">
      <div className="w-full bg-gradient-to-r from-[#0c2341]/90 to-[#0f3562]/90 backdrop-blur-lg p-4 rounded-xl border border-white/10 shadow-xl">
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-white text-lg font-semibold">Hub Conectado • Epictus IA</h3>
          <div className="flex items-center gap-2">
            <span className="text-white/70 text-xs">Tópicos conectados: 5</span>
            <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></div>
          </div>
        </div>
        <div className="grid grid-cols-5 gap-3">
          {['Matemática', 'Física', 'Química', 'Biologia', 'História'].map((topic, index) => (
            <motion.div
              key={index}
              className="bg-gradient-to-br from-[#FF6B00]/20 to-[#FF8736]/20 p-3 rounded-lg border border-white/5 cursor-pointer"
              whileHover={{ scale: 1.05, backgroundColor: 'rgba(255, 107, 0, 0.3)' }}
            >
              <div className="text-white font-medium text-sm">{topic}</div>
              <div className="text-white/60 text-xs mt-1">Conectado</div>
            </motion.div>
          ))}
        </div>
      </div>
