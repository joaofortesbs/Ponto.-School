...
export default function ModoExploracao() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold text-[#29335C]">Modo Exploração</h2>
        <div className="flex items-center gap-2">
          <div className="relative">
            <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 h-4 w-4" />
            <Input
              placeholder="Buscar tópicos..."
              className="pl-10 border-gray-200 focus:border-[#FF6B00] focus:ring-[#FF6B00]/20 w-60"
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
            />
          </div>
          <Button className="bg-gradient-to-r from-[#FF6B00] to-[#FF8C40] hover:from-[#FF6B00]/90 hover:to-[#FF8C40]/90 text-white shadow-sm">
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-md">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-start">
                    <h3 className="text-xl font-bold text-[#29335C]">
                  ...
                  <div className="mt-3">
                    <div className="flex justify-between items-center mb-1">
                      <span className="text-sm text-[#29335C]">Progresso</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="bg-gray-50 p-4 rounded-xl border border-gray-200">
                  <h4 className="font-bold text-[#29335C] mb-3 flex items-center gap-2">
                  ...
                  <div className="space-y-3">
                    {selectedTopicData.subtopics.map((subtopic, index) => (
                      <div
                        key={index}
                        className="flex items-center justify-between p-2 bg-white rounded-lg border border-gray-100 hover:border-[#FF6B00]/20 transition-all cursor-pointer"
                      >
                        <div className="flex items-center gap-2">
                          <div className="w-6 h-6 rounded-full bg-[#FF6B00]/10 flex items-center justify-center text-xs font-medium text-[#FF6B00]">
                            {index + 1}
                          </div>
                          <span className="text-sm text-[#29335C]">
                            {subtopic}
                          </span>
                        </div>
              ...
              <div className="bg-gradient-to-r from-[#29335C] to-[#001427] p-5 rounded-xl text-white">
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {filteredTopics.map((topic) => (
              <div
                key={topic.id}
                className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 hover:border-[#FF6B00]/50 cursor-pointer group"
              ...
              >
                <div className="flex items-center gap-4 mb-3">
                  ...
                  <div>
                    <h3 className="font-bold text-[#29335C] text-lg">
                      {topic.title}
                    </h3>
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-xs text-[#64748B] ml-1">4.0</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-4">
                  <div className="flex justify-between items-center mb-1">
                    <span className="text-xs text-[#29335C]">Progresso</span>
          ...
          {filteredTopics.length === 0 && (
            <div className="bg-white p-8 rounded-xl border border-gray-200 text-center">
              ...
              <h3 className="text-lg font-bold text-[#29335C] mb-2">
