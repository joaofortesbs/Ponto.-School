...
const FerramentasEmDesenvolvimentoModal: React.FC<FerramentasEmDesenvolvimentoModalProps> = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md bg-[#1A2634] border-[#3A4B5C]/50 text-white p-0 overflow-hidden">
        ...
        <div className="p-4">
          ...
          <div className="bg-[#2A3645]/70 rounded-lg p-4 mb-4">
        ...
        <div className="bg-[#1A2634]/70 border-t border-[#3A4B5C]/30 p-3 flex justify-end">
          <button
            onClick={onClose}
            className="px-4 py-2 rounded text-sm bg-amber-500 hover:bg-amber-600 text-white transition-colors"
          >
            Entendi
          </button>
        </div>
