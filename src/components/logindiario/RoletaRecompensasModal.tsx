...
const RoletaRecompensasModal: React.FC<RoletaRecompensasModalProps> = ({
  ...
  const prizeGroups = [
    ...
    [
      ...
      { name: "100 STs", color: "#FF9933", angle: 180, chance: 25 },
      ...
      { name: "999 STs", color: "#FF6B00", angle: 0, chance: 3 },
    ],
    // Após 1ª Regeneração
    [
      { name: "50 XP", color: "#FF9933", angle: 180, chance: 45 },
      { name: "99 STs", color: "#FFA366", angle: 240, chance: 25 },
    ...
    [
      ...
      { name: "199 STs", color: "#FFA366", angle: 240, chance: 25 },
      { name: "+3 Giros Grátis", color: "#FF7A1A", angle: 300, chance: 15 },
    ...
    // Após 3ª Regeneração
    [
      { name: "299 STs", color: "#FFA366", angle: 240, chance: 25 },
