...
const SupportChat: React.FC = () => {
  ...
  const getAIResponse = (message: string): string => {
    ...
    if (lowerMessage.includes("senha") || lowerMessage.includes("recuperar")) {
      ...
      return "Os Sparks são nossa moeda virtual. Você pode ganhar pontos completando cursos, participando de fóruns e realizando outras atividades. Eles podem ser trocados por recompensas na seção Carteira.";
    } else if (
      ...
      <div className="p-5 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-full overflow-hidden bg-[#778DA9] flex items-center justify-center">
            <img src="/vite.svg" alt="Logo" className="w-6 h-6 text-white" width={24} height={24} loading="lazy" decoding="async" />
          </div>
