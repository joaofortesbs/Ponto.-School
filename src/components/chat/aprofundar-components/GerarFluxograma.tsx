                    ...
                    if (!exportMenu) {
                      ...
                      exportMenu.innerHTML = `
                        <div className="flex flex-col space-y-1">
                          <button 
                            className="text-left px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md transition-colors flex items-center text-gray-700 dark:text-gray-300"
                            onClick={() => {
                              const flowWrapper = document.querySelector('.react-flow');
                              if (!flowWrapper) {
                                alert('Não foi possível encontrar o fluxograma para exportar.');
                              ...
                              import('html-to-image').then(htmlToImage => {
                                ...
                                console.error('Erro ao carregar biblioteca html-to-image:', error);
                                alert('Não foi possível carregar a biblioteca de exportação. Por favor, tente novamente.');
                                button.innerHTML = originalText;
                              });
                            }}
                          >
                          ...
                          <button className="text-left px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md transition-colors flex items-center text-gray-700 dark:text-gray-300 opacity-60 cursor-not-allowed" disabled>
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 mr-2 opacity-60" fill="none" viewBox="0 0 24 24" stroke="currentColor">
