    ...
    <div className={`w-full ${className}`}>
      ...
      <div className="flex bg-gray-100 dark:bg-gray-800 p-1 rounded-md mb-4">
        ...
        >
          <span className="flex items-center justify-center gap-1">
            <span className="text-sm">📋</span> Meus Grupos
          </span>
        </button>
        <button
        ...
        >
          <span className="flex items-center justify-center gap-1">
            <span className="text-sm">🔍</span> Recomendações IA
          </span>
        </button>
        <button
        ...
        >
          <span className="flex items-center justify-center gap-1">
            <span className="text-sm">📊</span> Estatísticas
          </span>
        </button>
      </div>
      ...
      <div className="relative mb-4">
        ...
        <Input
          ...
          className="pl-10 bg-white dark:bg-[#15243b] border-[#FF6B00]/10 dark:border-[#FF6B00]/20 h-10 focus-visible:ring-[#FF6B00] rounded-md w-full"
          value={searchQuery}
      ...
      {/* Tópicos de estudo */}
      <div className="mb-6">
        <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Tópicos de Estudo</h3>
        <div className="flex space-x-2 overflow-x-auto pb-2 scrollbar-hide">
          {topicosEstudo.map((topico) => (
            <div
              key={topico.id}
              className="flex-shrink-0 rounded-lg overflow-hidden cursor-pointer hover:opacity-90 transition-opacity"
