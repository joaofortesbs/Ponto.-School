...
const GruposEstudoInterface: React.FC<GruposEstudoInterfaceProps> = ({ className, onOpenCreateModal }) => {
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          ...
          <Button 
            variant="outline"
            className="text-[#FF6B00] border-[#FF6B00] hover:bg-[#FF6B00]/10 h-9 interface-selector"
            onClick={() => setIsEntrarPorCodigoModalOpen(true)}
          >
            <span className="interface-selector-icon">
              <Key className="h-4 w-4" />
            </span>
            <span className="interface-selector-text">Entrar com Código</span>
          </Button>
          <Button 
