...
export default function ProfileHeader({
  ...
  return (
    <div 
      className="bg-white dark:bg-[#0A2540] rounded-xl border border-[#E0E1DD] dark:border-white/10 shadow-lg overflow-hidden relative group hover:shadow-2xl transition-all duration-500 max-w-xs mx-auto"
    ...
    >
      ...
      <div className="h-28 bg-gradient-to-r from-[#001427] via-[#072e4f] to-[#0A2540] relative overflow-hidden">
        <motion.div 
        ...
        {/* Efeitos de luz */}
        <motion.div 
          className="absolute top-3 right-4 w-10 h-10 rounded-full bg-[#FF6B00]/20 blur-xl"
          animate={{ 
            opacity: [0.2, 0.6, 0.2],
            scale: [1, 1.2, 1]
          }}
        ...
        <motion.div
          className="absolute bottom-5 left-5 w-12 h-12 rounded-full bg-[#0064FF]/20 blur-xl"
          animate={{ 
            opacity: [0.1, 0.4, 0.1],
            scale: [1, 1.3, 1]
          }}
      ...
      {/* Avatar Section - Moved outside of cover */}
      <div className="relative z-20 flex justify-center -mt-10">
        ...
        >
          <div className="relative group">
            ...
            >
              <Avatar className="w-24 h-24 border-4 border-white dark:border-[#0A2540] shadow-xl group-hover:border-[#FF6B00]/20 transition-all duration-300">
                <AvatarImage
            ...
            >
              <div className="bg-[#FF6B00] text-white p-1.5 rounded-full w-7 h-7 flex items-center justify-center shadow-lg group-hover:shadow-[#FF6B00]/40 transition-all duration-300">
      ...
      {/* Profile Info */}
      <div className="pt-3 pb-4 px-4 text-center relative z-10">
        <motion.h2
          ref={profileNameRef}
        ...
        >
          <span className="bg-gradient-to-r from-[#FF6B00] to-[#FF9B50] text-white text-xs font-medium px-2 py-0.5 rounded-full flex items-center gap-1 shadow-md hover:shadow-lg hover:shadow-[#FF6B00]/20 transition-all duration-300 cursor-pointer">
        ...
        >
          ...
          >
            <div className="flex flex-col items-center justify-center">
              ...
              <p className="text-sm font-bold text-[#29335C] dark:text-white">
                {userProfile?.level || 1}
              </p>
            ...
            {showStatsDetails && (
              <motion.div 
                ...
                exit={{ opacity: 0, y: 10 }}
                className="absolute -top-16 left-1/2 transform -translate-x-1/2 bg-white dark:bg-[#1E293B] p-1.5 rounded-lg shadow-lg text-[10px] z-20 w-36 border border-[#E0E1DD] dark:border-white/10"
              >
                <div className="text-center mb-0.5 font-medium text-[#29335C] dark:text-white">Detalhes do Nível</div>
          ...
          >
            <div className="flex flex-col items-center justify-center">
              ...
              <p className="text-sm font-bold text-[#29335C] dark:text-white">8</p>
          ...
          >
            <div className="flex flex-col items-center justify-center">
              ...
              <p className="text-sm font-bold text-[#29335C] dark:text-white">12</p>
              ...
              <AnimatePresence>
                {showTooltip && (
                  <motion.div 
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0, y: 5 }}
                    className="absolute right-4 -mt-10 px-2 py-1.5 bg-black/80 text-white text-[10px] rounded-lg shadow-lg backdrop-blur-sm z-50 w-28 text-center"
                  >
        ...
        >
          <Button
            className="flex-1 h-8 bg-gradient-to-r from-[#FF6B00] to-[#FF9B50] hover:from-[#FF5B00] hover:to-[#FF8B40] text-white text-xs shadow-md hover:shadow-lg hover:shadow-[#FF6B00]/20 transition-all duration-300 group flex items-center justify-center relative overflow-hidden"
            onClick={onEditClick}
          >
            {/* Efeito de brilho no hover */}
            <span className="absolute w-24 h-24 -mt-10 -ml-10 bg-white rotate-12 opacity-0 group-hover:opacity-10 transition-opacity duration-1000 transform group-hover:translate-x-32 group-hover:translate-y-8 pointer-events-none"></span>
            ...
            <div className="h-5 w-full relative overflow-hidden">
              {recentAchievements.map((achievement, index) => (
                ...
                >
                  ...
                  <span className="text-[#64748B] dark:text-white/60 text-[8px]">• {achievement.date}</span>
                </motion.div>
              ))}
            </div>
