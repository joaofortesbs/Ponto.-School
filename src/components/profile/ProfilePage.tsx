      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="w-full md:w-2/3">
            <div className="bg-white dark:bg-[#0A2540] rounded-xl border border-[#E0E1DD] dark:border-white/10 overflow-hidden shadow-sm mb-6 h-[840px]">
              <Tabs
                value={activeTab}
            ...
            <div className="bg-white dark:bg-[#0A2540] rounded-xl border border-[#E0E1DD] dark:border-white/10 overflow-hidden shadow-sm p-6 h-[840px]">
