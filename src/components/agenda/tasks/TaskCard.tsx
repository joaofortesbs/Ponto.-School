    ...
    <Draggable draggableId={task.id} index={index}>
      {(provided, snapshot) => (
        <div
          ...
          className={`bg-white dark:bg-[#29335C]/30 rounded-lg p-3 shadow-sm border-l-4 ${getPriorityColor()} hover:shadow-md transition-all duration-300 cursor-grab ${
            snapshot.isDragging ? "opacity-50 scale-95" : "hover:scale-[1.02]"
