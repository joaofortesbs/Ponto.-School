          ...
          <div className="p-8 text-center">
            <div className="flex justify-center mb-6">
              <div className="bg-blue-100 dark:bg-blue-900/20 p-6 rounded-full relative">
                <Wrench className="h-16 w-16 text-[#2563eb]" />
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-md mx-auto mb-6">
              Esta funcionalidade está sendo desenvolvida especialmente para você. 
              Em breve você terá acesso a recursos incríveis para potencializar seus estudos!
            </p>
            ...
            <Button
              onClick={() => navigate('/')}
              className="bg-gradient-to-r from-[#2563eb] to-[#3b82f6] text-white hover:from-[#1d4ed8] hover:to-[#2563eb] transition-all duration-300"
            >
