...
import { BellPlus, BellRing, Clock, Construction, Wallet } from "lucide-react";
import { motion } from "framer-motion";

export default function InterfaceCarteira() {
      ...
      >
        ...
        <div className="p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-xl font-bold text-[#29335C] dark:text-white">Carteira em Desenvolvimento</h2>
          </div>
          ...
          {notificationsEnabled && (
            ...
            >
              Você receberá um aviso quando a Carteira estiver disponível!
            </motion.p>
          )}
        </div>
      </motion.div>
