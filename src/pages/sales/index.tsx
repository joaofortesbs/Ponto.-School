  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-gradient-to-b from-[#0A1628] via-[#0D1B2A] to-[#1B263B]">
      ...
      <motion.div
        ...
        className="relative z-10 flex min-h-screen items-end justify-center px-4 pt-24 pb-48"
      >
        <div className="relative w-full max-w-[1800px] mx-auto">
          <div className="flex items-start justify-between w-full">
            ...
            <div className="text-center flex-1 px-8">
              ...
              <div className="w-full max-w-4xl mx-auto flex flex-col gap-6 items-center justify-center mt-16">
