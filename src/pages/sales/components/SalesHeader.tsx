            ...
            <DropdownMenu modal={false} open={isLanguageDropdownOpen} onOpenChange={setIsLanguageDropdownOpen}>
              ...
              >
                <DropdownMenuItem
                  ...
                  className="flex items-center gap-3 px-4 py-2.5 rounded-lg cursor-pointer hover:bg-white/10 transition-colors text-white focus:bg-white/10 focus:text-white outline-none"
                >
                  <img src="/images/bandeira-brasil.webp" alt="Brasil" width={24} height={17} className="w-6 h-6 object-cover rounded" loading="lazy" decoding="async" />
                ...
                <DropdownMenuItem
                  ...
                  className="flex items-center gap-3 px-4 py-2.5 rounded-lg cursor-pointer hover:bg-white/10 transition-colors text-white focus:bg-white/10 focus:text-white outline-none"
                >
                  <img src="/images/bandeira-estados-unidos.webp" alt="USA" width={24} height={13} className="w-6 h-6 object-cover rounded" loading="lazy" decoding="async" />
                ...
                <DropdownMenuItem
                  ...
                  className="flex items-center gap-3 px-4 py-2.5 rounded-lg cursor-pointer hover:bg-white/10 transition-colors text-white focus:bg-white/10 focus:text-white outline-none"
                >
                  <img src="/images/bandeira-espanha.webp" alt="España" width={24} height={16} className="w-6 h-6 object-cover rounded" loading="lazy" decoding="async" />
                ...
                <DropdownMenuItem
                  ...
                  className="flex items-center gap-3 px-4 py-2.5 rounded-lg cursor-pointer hover:bg-white/10 transition-colors text-white focus:bg-white/10 focus:text-white outline-none"
                >
                  <img src="/images/bandeira-franca.webp" alt="France" width={24} height={16} className="w-6 h-6 object-cover rounded" loading="lazy" decoding="async" />
                ...
                <DropdownMenuItem
                  ...
                  className="flex items-center gap-3 px-4 py-2.5 rounded-lg cursor-pointer hover:bg-white/10 transition-colors text-white focus:bg-white/10 focus:text-white outline-none"
                >
                  <img src="/images/bandeira-japao.webp" alt="日本" width={24} height={16} className="w-6 h-6 object-cover rounded" loading="lazy" decoding="async" />
                ...
                <DropdownMenuItem
                  ...
                  className="flex items-center gap-3 px-4 py-2.5 rounded-lg cursor-pointer hover:bg-white/10 transition-colors text-white focus:bg-white/10 focus:text-white outline-none"
                >
                  <img src="/images/bandeira-alemanha.webp" alt="Deutschland" width={24} height={14} className="w-6 h-6 object-cover rounded" loading="lazy" decoding="async" />
