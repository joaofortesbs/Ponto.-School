        ...
        <div className="bg-white dark:bg-[#0A2540] rounded-2xl shadow-xl overflow-hidden border border-gray-200 dark:border-white/10">
          ...
          <div className="p-8 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-md mx-auto mb-6">
              A interface de Trilhas School para alunos está sendo desenvolvida. 
              Em breve você terá acesso a trilhas de aprendizagem personalizadas 
              criadas pelos seus professores.
            </p>
...
export default TrilhasSchoolAlunoInterface;
