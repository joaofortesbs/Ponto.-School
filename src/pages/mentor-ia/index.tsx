...
export default function MentorIAPage() {
  ...
  const tools: Tool[] = [
    ...
    },
    {
      ...
      description: "Mergulhe em um tema com o guia do Mentor IA.",
      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-4 mb-6">
        <div>
          <h1 className="text-2xl font-bold text-[#29335C] dark:text-white flex items-center gap-2">
            <Brain className="h-6 w-6 text-[#00FFFF]" /> Mentor IA
          </h1>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {tools.slice(0, 6).map((tool) => (
                        <Card
                          key={tool.id}
                          className="bg-white dark:bg-[#29335C]/10 border-[#E0E1DD] dark:border-[#29335C]/50 hover:shadow-md transition-all duration-300 hover:scale-[1.02] cursor-pointer"
                        >
                      ...
                      <Card className="bg-white dark:bg-[#29335C]/10 border-[#E0E1DD] dark:border-[#29335C]/50 hover:shadow-md transition-all duration-300 hover:scale-[1.02] cursor-pointer">
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {[
                        ...
                        <div
                          key={index}
                          className="flex justify-between items-center p-3 border border-[#E0E1DD] dark:border-[#29335C]/50 rounded-lg hover:bg-[#E0E1DD]/10 dark:hover:bg-[#29335C]/20 transition-colors cursor-pointer"
                        >
                          <div className="flex items-center gap-3">
                        ...
                        <CardContent className="p-4">
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <Button
                              variant="ghost"
                              size="sm"
                              className="text-xs text-[#64748B] dark:text-white/60"
                            >
                              Por quê?
                            </Button>
                          </div>
              ...
              <TabsContent value="plano-estudos" className="mt-0">
                <div className="space-y-6">
                  ...
                  <Card className="bg-white dark:bg-[#29335C]/10 border-[#E0E1DD] dark:border-[#29335C]/50">
                    <CardHeader>
                      <CardTitle className="text-[#29335C] dark:text-white text-lg">
                        Plano Atual
                      </CardTitle>
                    ...
                    <CardFooter className="flex justify-between border-t border-[#E0E1DD] dark:border-[#29335C]/50 pt-4">
                      <Button
                        variant="outline"
                        className="border-[#E0E1DD] dark:border-[#29335C]/50"
                      >
