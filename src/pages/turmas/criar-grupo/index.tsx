...
export default function CriarGrupoPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simular criação bem-sucedida e redirecionar após 2 segundos
    setTimeout(() => {
      navigate("/turmas?view=grupos");
    }, 2000);
  };
    ...
    <div className="w-full h-full bg-[#f7f9fa] dark:bg-[#001427] p-6 space-y-6 transition-colors duration-300">
      ...
      >
        <div className="flex items-center gap-3">
          <Button
            variant="ghost"
            size="icon"
            className="rounded-full hover:bg-[#FF6B00]/10 transition-colors"
          ...
          <div>
            ...
            <p className="text-[#778DA9] dark:text-gray-400 text-sm font-open-sans">
              Crie um grupo colaborativo para estudar com seus colegas
            </p>
          </div>
        </div>
      </motion.div>
      ...
      {showSuccess && (
        <motion.div
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          className="bg-green-100 dark:bg-green-900/30 border border-green-300 dark:border-green-700 text-green-800 dark:text-green-300 p-4 rounded-lg mb-6 flex items-center gap-3"
        >
          <Check className="h-5 w-5 text-green-500" />
          <div>
            <h3 className="font-medium">Grupo criado com sucesso!</h3>
            <p className="text-sm">Redirecionando para a página de grupos...</p>
          </div>
        </motion.div>
      )}
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p className="w-[200px] text-xs">
                                Escolha um nome descritivo para seu grupo de
                                estudos
                              </p>
                            </TooltipContent>
                          </Tooltip>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="restrito">
                            <div className="flex items-center gap-2">
                              ...
                              <span>
                                Restrito (visível, mas requer aprovação)
                              </span>
                            </div>
                          </SelectItem>
                ...
                <TabsContent value="participantes" className="space-y-6">
                  <div className="bg-[#FF6B00]/5 dark:bg-[#FF6B00]/10 rounded-lg p-4 border border-[#FF6B00]/10 dark:border-[#FF6B00]/20 mb-6">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                      Convide colegas para participar do seu grupo de estudos.
                      Eles receberão uma notificação e poderão aceitar ou
                      recusar o convite.
                    </p>
