...
export function CardDeConstrucao({
  ...
  if (step === 'generating' || step === 'generatingActivities') {
    return (
      <motion.div
        ...
        className="relative bg-gradient-to-br from-gray-900/90 to-gray-800/90 backdrop-blur-xl rounded-2xl p-8 max-w-4xl w-full shadow-2xl border border-[#FF6B00]/30"
        style={{
          background: `
          ...
          >
            <div>
              ...
              <textarea
                ...
                className="w-full p-4 border-2 border-[#FF6B00]/30 bg-gray-800/50 text-white rounded-xl focus:ring-2 focus:ring-[#FF6B00] focus:border-[#FF6B00] transition-all duration-200 backdrop-blur-sm placeholder-gray-400"
                rows={3}
