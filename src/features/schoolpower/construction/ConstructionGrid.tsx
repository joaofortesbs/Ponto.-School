The code has been updated to include edit functionality for construction activities.
```
...
export function ConstructionGrid({ approvedActivities, onEditActivity }: ConstructionGridProps) {
  ...
  const handleEdit = (id: string) => {
    ...
    const activity = activities.find(act => act.id === id);
    if (activity && onEditActivity) {
      The code has been updated to include edit functionality for construction activities and pass original data when editing.