...
import { Target, BarChart3, Clock, ChevronDown, ChevronRight, Calendar, FileText } from 'lucide-react';
...
const DiagnosticoCard: React.FC<DiagnosticoCardProps> = ({ diagnostico }) => {
  ...
  return (
    <Card className="border-orange-300 bg-gradient-to-br from-orange-50 to-amber-100 h-full hover:shadow-xl hover:scale-[1.02] transition-all duration-300 border-2">
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between mb-3">
          <Badge className="bg-orange-500 text-white border-orange-600 px-3 py-1 font-medium shadow-sm">
