...
const AvaliacaoCard: React.FC<AvaliacaoCardProps> = ({ avaliacao }) => {
  ...
  return (
    <Card className="border-purple-300 bg-gradient-to-br from-purple-50 to-purple-100 h-full hover:shadow-xl hover:scale-[1.02] transition-all duration-300 border-2 rounded-2xl cursor-pointer active:scale-95">
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between mb-3">
          <Badge className="bg-purple-600 text-white border-purple-700 px-3 py-1 font-medium shadow-sm">
      ...
      <CardContent className="pt-0 space-y-3">
        ...
        <div className="bg-white/60 rounded-lg p-3 border border-purple-200">
          <button
            ...
            className="w-full flex items-center justify-between text-left hover:bg-purple-50/50 -m-1 p-1 rounded transition-colors"
          >
