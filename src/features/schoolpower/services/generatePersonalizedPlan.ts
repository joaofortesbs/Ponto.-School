...
async function callGeminiAPI(prompt: string): Promise<string> {
  ...
  try {
    ...
    // Log da requisição
    console.log('📤 Enviando requisição para Gemini', { prompt_length: prompt.length, config: requestBody.generationConfig });
    ...
    console.log('📥 Resposta recebida da API Gemini', { executionTime, response_length: generatedText.length });
