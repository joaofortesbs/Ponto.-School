/**
 * EXECUTION PLAN CARD - Card Visual do Plano de Execução
 * 
 * Exibe o plano de ação gerado pela IA com as etapas numeradas
 * e permite ao usuário iniciar a execução
 */
      ...
      <div className="p-4 space-y-3">
        ...
        {plan.etapas.map((etapa, idx) => (
          <motion.div
            ...
            className={`flex items-start gap-3 p-3 rounded-xl border transition-all ${getStepStatusColor(etapa)}`}
          >
