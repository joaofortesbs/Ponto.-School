          ...
          <Card className="bg-white/95 dark:bg-gray-900/95 border-gray-200 dark:border-gray-700 rounded-2xl shadow-lg overflow-hidden h-full">
            <CardContent className="p-0 h-full flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto custom-scrollbar min-h-[350px] relative">
                ...
                {/* Container unificado FIXO: Overlay + Ícone + Texto */}
                <div 
                  className="fixed inset-0 z-30 pointer-events-auto cursor-default bg-black/0 group-hover:bg-black/40 transition-all duration-700 ease-in-out flex items-center justify-center"
                  style={{ 
                    position: 'fixed',
                    top: 0,
                    left: 0,
