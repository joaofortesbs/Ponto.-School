...
import { CRIAR_COMPROMISSO_CAPABILITIES } from './CRIAR_COMPROMISSO/registry';
...
export const CAPABILITIES = {
  ...
  CRIAR: { ...CRIAR_ATIVIDADES_CAPABILITIES, ...CRIAR_ARQUIVO_CAPABILITIES, ...CRIAR_COMPROMISSO_CAPABILITIES },
  SALVAR: SALVAR_BD_CAPABILITIES,
};

export const CRIAR_CAPABILITIES = { ...CRIAR_ATIVIDADES_CAPABILITIES, ...CRIAR_COMPROMISSO_CAPABILITIES };
