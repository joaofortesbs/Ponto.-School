      ...
      <style jsx>{`
        .message-container {
          ...
          box-shadow: ${isDarkTheme 
            ? `0 15px 30px rgba(0, 0, 0, 0.3), 0 8px 16px rgba(0, 0, 0, 0.2), 0 3px 8px rgba(0, 0, 0, 0.15), inset 0 1px 0 rgba(255, 255, 255, 0.1)`
            : `0 15px 30px rgba(0, 0, 0, 0.1), 0 8px 16px rgba(0, 0, 0, 0.05), 0 3px 8px rgba(0, 0, 0, 0.03), inset 0 1px 0 rgba(255, 255, 255, 0.8)`};
          width: 600px;
        ...
        .inner-container {
          ...
          border-radius: 18px;
          padding: 20px;
          border: ${isDarkTheme ? '1px solid #333' : '1px solid rgba(0, 0, 0, 0.08)'};
          transition: all 0.3s ease;
        }
        ...
        .textarea-custom {
          background: transparent;
          border: none;
          color: ${isDarkTheme ? '#e0e0e0' : '#2d3748'};
          font-size: 16px;
          line-height: 1.5;
          resize: none;
          outline: none;
        ...
        .mode-dropdown {
          ...
          margin-bottom: 12px;
          min-width: 180px;
          box-shadow: 0 20px 40px rgba(0, 0, 0, 0.6), 0 70px 20px rgba(0, 0, 0, 0.4), 0 0 0 1px rgba(255, 107, 53, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.1);
          z-index: 1000;
    ...
    >
      ...
      <div className="absolute top-[57%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20 pointer-events-none">
        <div className="relative" style={{ width: "900px", height: "617px" }}>
          ...
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-full z-30 pointer-events-none" style={{ marginTop: "-10px" }}>
