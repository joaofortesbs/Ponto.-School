...
export function SchoolPowerPage({ isQuizMode = false }: SchoolPowerPageProps) {
  ...
  return (
    <div
      className={`relative flex ${isMobile && isQuizMode ? 'h-screen min-h-screen' : 'h-[calc(100vh-116px)] sm:h-[calc(100vh-120px)] md:h-[calc(100vh-128px)] -mt-4 -mb-4'} w-full max-w-[98%] sm:max-w-[1589px] mx-auto flex-col items-center justify-center overflow-hidden rounded-2xl border border-gray-200 dark:border-white/10`}
      style={{ 
