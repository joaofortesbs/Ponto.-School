...
- **2026-02-13**: Collapsible Phase Accordion + Anti-Redundancy System:
  ...
  3. **Anti-Redundancy + Strategic Insight Prompt**: Text between phase header and activity markers must be a STRATEGIC PARAGRAPH of 2-4 sentences. Must contain at least 2 of: WHY chosen, HOW to apply, HOW activities complement each other, WHEN to use, contextual tips, connections to other phases. NEVER generic one-liners. Three ERRADO examples (per-activity text, generic short phrase, redundant name repetition) + one CORRETO example (rich 3-sentence strategic paragraph).
