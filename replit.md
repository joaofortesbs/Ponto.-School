...
- **Core Features**:
    ...
    - **Powers System v4.0 ENTERPRISE DB-FIRST (Feb 2026)**: Virtual currency for AI capabilities with per-action pricing and enterprise-grade bidirectional synchronization between localStorage and Neon DB. 
